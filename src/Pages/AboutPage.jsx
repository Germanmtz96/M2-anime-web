...
function AboutPage() {
  return (
    ...
    <Card.Body >
      ...
      <div id="cards-about">
    <Card  id='about' style={{ width: '14rem' , backgroundColor: '#89b4fb', marginLeft:'10px'}}>
    ...
    <Card  id='about' style={{ width: '14rem' , backgroundColor: '#89b4fb',marginLeft:'10px',marginRight:'10px'}}>
