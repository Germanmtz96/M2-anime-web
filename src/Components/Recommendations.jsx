...
function Recommendations(props) {
  ...
  return (
    <div id="all-cards-recommendations" style={{display:'flex' , marginTop:'30px',justifyContent:"space-between",gap:"0"} }>
<Link   to={`/anime-list/${props.recommendationArr[0].entry.mal_id}` } >
    <Card style={{ width: '5rem', margin: '10px' , backgroundColor: '#89b4fb'}} >
